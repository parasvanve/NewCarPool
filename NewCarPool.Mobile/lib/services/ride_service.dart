...
class RideService {
  ...
  Future<RideShareResponse> getRideShare(String rideId) async {
    final response = await _apiClient.dio.get('/rides/$rideId/share');

    return RideShareResponse.fromJson(Map<String, dynamic>.from(response.data));
  }
