    ...
    return AuthShell(
      ...
      children: [
        Wrap(
          ...
          runSpacing: 8,
          children: const [
            _TrustBadge(icon: Icons.verified_user, label: 'Secure Login'),
            _TrustBadge(icon: Icons.route, label: 'Realtime Trips'),
          ],
        ),
        const SizedBox(height: 14),
        Form(
...
/// A small, non-interactive trust indicator (e.g. "Secure Login").
///
/// Deliberately avoids Chip/ButtonStyle visuals (elevation, ripple,
/// strong border, filled background) so users don't mistake it for
/// a tappable element. Purely informational — no onTap, no InkWell.
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        // No border — bordered pills read as buttons.
      ),
      child: Row(
