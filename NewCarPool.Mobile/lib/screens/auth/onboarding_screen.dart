                  ...
                  child: PageView(
                    ...
                    children: [
                      _PageFrame(
                        ...
                        subtitle:
                            'Find rides that match your route and book in a few taps.',
                      ...
                      _PageFrame(
                        ...
                        subtitle:
                            'Add pickup, destination, stop points, seats, and price.',
                      ...
                      _PageFrame(
                        ...
                        subtitle:
                            'Chat with Rider or passenger, track rides live, and get booking or cancellation alerts.',
                    ...
                    child: DecoratedBox(
                      decoration: BoxDecoration(
                        ...
                        gradient: const LinearGradient(
                            colors: [Color(0xFF2F5BFF), Color(0xFF5D4AF5)]),
                        boxShadow: const [
                          BoxShadow(
                              color: Color(0x2A3F58C7),
                              blurRadius: 18,
                              offset: Offset(0, 8))
                        ],
                      ),
      ...
      child: Column(
        children: [
          ...
          Text(
            ...
            style: const TextStyle(
                fontSize: 39, fontWeight: FontWeight.w800, height: 1.08),
          ),
          ...
          ConstrainedBox(
            ...
            child: Text(
              ...
              textAlign: TextAlign.center,
              style: const TextStyle(
                  fontSize: 18, color: Color(0xFF5D6881), height: 1.35),
            ),
          ),
        ],
      ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 2),
                        Text('Today, 9:30 AM • 3 seats left',
                ...
                child: Stack(
                  children: [
                    ...
                    const Positioned(
                        ...
                        bottom: 52,
                        child: _Pin(
                            color: Color(0xFF16A34A), icon: Icons.trip_origin)),
                    const Positioned(
                        right: 38,
                        top: 58,
                        child: _Pin(
                            color: Color(0xFFEF4444), icon: Icons.location_on)),
                    Positioned(
                      bottom: 8,
                      right: 18,
                      child: Container(
      ...
      child: Stack(
        children: [
          ...
          const Positioned(
              left: 36,
              bottom: 60,
              child: _Pin(color: Color(0xFF16A34A), icon: Icons.trip_origin)),
          const Positioned(
              left: 148,
              top: 130,
              child: _Pin(
                  color: Color(0xFF6366F1), icon: Icons.radio_button_checked)),
          const Positioned(
              right: 94,
              top: 90,
              child: _Pin(
          ...
          const Positioned(
              right: 32,
              top: 40,
              child: _Pin(color: Color(0xFFEF4444), icon: Icons.location_on)),
          const Positioned(top: 24, left: 24, child: _ChipLabel('Pickup')),
          const Positioned(
              top: 24, right: 26, child: _ChipLabel('Destination')),
          const Positioned(bottom: 86, left: 24, child: _ChipLabel('Add stop')),
          const Positioned(
              bottom: 22, left: 20, child: _ChipLabel('3 seats available')),
          const Positioned(
              bottom: 22, right: 20, child: _ChipLabel('Your price ₹100')),
          Positioned(
            left: 0,
            right: 0,
            bottom: 6,
            child: Center(
              child: Container(
                ...
                child: const Icon(Icons.directions_car,
                    color: Color(0xFF315CFF), size: 28),
              ),
            ),
          ),
        ],
              ...
              child: Stack(
                children: [
                  ...
                  const Positioned(
                      ...
                      top: 22,
                      child: _ChatBubble(
                          text: 'Hi, I’m on my way.', alignEnd: false)),
                  const Positioned(
                      right: 20,
                      top: 72,
                      child: _ChatBubble(
                          text: 'Great! See you soon.', alignEnd: true)),
                  Positioned(
                    top: 130,
                    left: 38,
                    child: Container(
                      ...
                      child: const Row(
                        children: [
                          Icon(Icons.notifications_active,
                              color: Color(0xFF325BFF), size: 18),
                          SizedBox(width: 6),
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(
                            colors: [Color(0xFF315CFF), Color(0xFF6A4BF7)]),
                        borderRadius: BorderRadius.circular(16),
                      ),
                      child: const Row(
                        children: [
                  ...
                  const Positioned(
                    ...
                    child: Center(
                      child: _Pin(
                          color: Color(0xFF315CFF), icon: Icons.directions_car),
                    ),
                  ),
                ],
              ),
...
class _RoutePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final path = Path()
      ...
      ..quadraticBezierTo(size.width * 0.32, size.height * 0.72,
          size.width * 0.42, size.height * 0.58)
      ..quadraticBezierTo(size.width * 0.54, size.height * 0.40,
          size.width * 0.62, size.height * 0.33)
      ..quadraticBezierTo(size.width * 0.76, size.height * 0.22,
          size.width * 0.83, size.height * 0.15);
    final paint = Paint()
      ..shader =
          const LinearGradient(colors: [Color(0xFF325BFF), Color(0xFF6A4BF7)])
